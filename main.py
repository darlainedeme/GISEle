...
from scripts import home, area_selection, data_retrieve, buildings, clustering_modes, data_visualization, costs, summary_analysis, demand_estimation, results, routing_preparation, local_area_optimization
...
main_nav = st.sidebar.radio("Navigation", [
    ...
    "Routing Preparation", "Local Area Optimization", "Results"
])
...
elif main_nav == "Routing Preparation":
    routing_preparation.show()
elif main_nav == "Local Area Optimization":
